...
void aesenc(unsigned char *s, const unsigned char *rk) 
 files with 125 additions and 28 deletions.
  8  
src/Makefile.am
@@ -467,8 +467,8 @@ endif
...
@@ -482,8 +482,8 @@ crypto_libverus_crypto_a_SOURCES = \
...
#include <string.h>
#include <stdlib.h>
@@ -9,6 +6,58 @@ Plain C implementation of the Haraka256 and Haraka512 permutations.
...
static const unsigned char haraka_rc[40][16] = {
    {0x9d, 0x7b, 0x81, 0x75, 0xf0, 0xfe, 0xc5, 0xb2, 0x0a, 0xc0, 0x20, 0xe6, 0x4c, 0x70, 0x84, 0x06},
    {0x17, 0xf7, 0x08, 0x2f, 0xa4, 0x6b, 0x0f, 0x64, 0x6b, 0xa0, 0xf3, 0x88, 0xe1, 0xb4, 0x66, 0x8b},
@@ -81,7 +130,48 @@ static const unsigned char sbox[256] =
#define XT(x) (((x) << 1) ^ ((((x) >> 7) & 1) * 0x1b))
